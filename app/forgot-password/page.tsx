...
import { ForgotPasswordForm } from "@/components/_components/forgot-password-form";
import { ForgotPasswordImage, Logo } from "@/public";
      ...
      <div className="flex-1 container mx-auto px-4 py-8">
        <div className="max-w-6xl mx-auto rounded-lg overflow-hidden">
          <div className="grid md:grid-cols-2 gap-8 p-8">
            ...
            <div className="bg-[#efefef] rounded-3xl p-6 items-center justify-center hover:shadow-amber-200 hover:shadow-2xl hidden md:flex">
              <Image
