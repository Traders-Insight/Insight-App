...
import SignupForm from "@/components/_components/signup-form";
import { SignUpImg, Logo } from "@/public";
  ...
  return (
    <main className="min-h-screen md:mx-30 flex flex-col">
      ...
      <div className="flex-1 container mx-auto px-4 py-8 grid md:grid-cols-2 gap-8 items-center">
        <div className="bg-[#efefef] rounded-3xl p-6 md:flex items-center justify-center hover:shadow-amber-200 hover:shadow-2xl hidden">
          <Image
            src={SignUpImg}
